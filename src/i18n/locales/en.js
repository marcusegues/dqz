...
export const en: Locale = {
  ...
  customsProcedures: {
    ...
    customsProceduresText17:
      'At certain border crossings, so-called declaration boxes are still available for you to declare your goods in writing. Information on these can be found at',
