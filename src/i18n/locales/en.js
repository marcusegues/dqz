...
export const en: Locale = {
  ...
  souvenirsAndSpeciesProtection: {
    souvenirsAndSpeciesProtectionMainText: 'Souvenirs and species protection (CITES)',
    souvenirsAndSpeciesProtectionSubText: '',
    souvenirsAndSpeciesProtectionText1: 'Souvenirs',
    souvenirsAndSpeciesProtectionText2: 'Elephant leather belts, dream catchers with bird-feathers or sandalwood joss sticks – there are all sorts of souvenirs. People do not always realise that the items are made using protected animals or plants (e.g. tropical timber). Yet many things may not be brought into Switzerland at all. Even before going away, it is worth clarifying which souvenirs are suitable and which are best left behind at the holiday resort.',
    souvenirsAndSpeciesProtectionText3: 'Species protection – animals',
    souvenirsAndSpeciesProtectionText4: 'The importation of protected animals or products thereof is either completely prohibited or is subject to authorisation (this includes e.g. snakes, lizards, tortoises, parrots, ivory, tortoise-shell and various fur skins).',
    souvenirsAndSpeciesProtectionText5: 'Upon importation, an export permit or a re-exportation certificate issued by the CITES authority in the country of origin must be submitted to the CITES control office.',
    souvenirsAndSpeciesProtectionText6: 'Species protection – plants',
    souvenirsAndSpeciesProtectionText7: 'The importation of protected plants or products thereof is either completely prohibited or is subject to authorisation (e.g. orchids, cacti, certain types of wood and medicinal plants).',
    souvenirsAndSpeciesProtectionText8: 'Information and authorisations are provided by the Federal Food Safety and Veterinary Office FSVO: www.blv.admin.ch',
  },

  highwayVignette: {
    highwayVignetteMainText: 'Motorway tax sticker',
    highwayVignetteSubText: '',
    highwayVignetteText1: 'A charge is payable for using motor vehicles and trailers of up to 3.5 tonnes each on motorways. The price of the motorway tax sticker is CHF 40.',
    highwayVignetteText2: 'Points of sale',
    highwayVignetteText3: 'In Switzerland, the motorway tax sticker can be obtained at post offices and petrol stations, for example.',
    highwayVignetteText4: 'You can get a motorway tax sticker from Customs staff at manned border crossings. You can pay with a credit card or cash (CHF, EUR, USD, GBP).',
    highwayVignetteText5: 'The motorway tax sticker is obtainable abroad from motoring organisations; in the vicinity of the Swiss border, it is also available at motorway petrol stations and kiosks or "Trafiken" in Austria.',
    highwayVignetteText6: 'Affixing the motorway tax sticker',
    highwayVignetteText7: 'The motorway tax sticker is valid only if it is affixed to the vehicle:',
    highwayVignetteText8: 'In the case of passenger cars, to the inside of the windscreen (not behind the tinted section)',
    highwayVignetteText9: 'In the case of trailers and motor bikes, to an easily accessible and non-replaceable part.',
    highwayVignetteText10: 'Motorway tax stickers which have only been affixed using sticky tape or in any other way are invalid. You will be fined CHF 200 if you travel on the motorway with an invalid motorway tax sticker or without one. You will also have to purchase a motorway tax sticker and affix it to the vehicle.',
  },

  roadTax: {
    roadTaxMainText: 'Road traffic fees over 3.5T (lump-sum heavy vehicle charge, or PSVA)',
    roadTaxSubText: '',
    roadTaxText1: 'In Switzerland, a heavy vehicle charge is levied for vehicles and trailers with a total weight of over 3.5 tonnes. The charge is levied as a daily lump sum for buses, heavy motorhomes, heavy passenger vehicles and their trailers over 3.5 tonnes.',
    roadTaxText2: 'Unlike the motorway tax sticker for passenger cars, the heavy vehicle charge is payable on the entire road network, and not only on motorways.',
    roadTaxText3: 'For heavy goods vehicles and their trailers, see: www.lsva.ch',
    roadTaxText4: 'Please note: The vehicle is subject to the lump-sum heavy vehicle charge even if it is only parked and not driven (e.g. motorhome on a campsite).',
    roadTaxText5: 'Payment and rates',
    roadTaxText6: 'The calculation is based on the total weight and/or the towing weight of the tractor unit (in accordance with the vehicle registration document) and the applicable period.',
  ...
  fuelAndRepairs: {
    ...
    fuelAndRepairsText2: 'The contents of the fuel tank are tax and duty-free. In addition, you can import up to 25 litres of fuel tax and duty-free in a spare fuel container. You will have to pay CHF 0.75 customs duty for each additional litre, as well as VAT on the value of the fuel.',
    fuelAndRepairsText3: 'Repair and maintenance costs',
    fuelAndRepairsText4: 'If the duty-free limit of CHF 300 is exceeded, you have to pay VAT for all repair and maintenance costs (repairs to vehicles, electronic devices, furniture, jewellery, etc.). More detailed information can be found at:',
  ...
  entryByTrain: {
    ...
    entryByTrainSubText: '',
    entryByTrainText1: 'If there are Customs agents on the train, all goods you are carrying must be spontaneously declared for customs clearance. You can clear goods intended for your personal use or as gifts with the app "xxx" before crossing the border. These declarations are binding.',
    entryByTrainText2: 'If no Customs staff are present and you do not want to use the app "xxx" for customs clearance, you can do the following:',
    entryByTrainText3: 'get off the train at the border train station and declare your personal goods in writing (written self-declaration at a declaration box); or',
    entryByTrainText4: 'declare the goods later on (within 7 days) at any customs office during opening hours.',
    entryByTrainText5: 'Please note: On certain regional trains, you may only bring with you personal goods that:',
    entryByTrainText6: 'are within the duty-free allowances and the tax-free limit of CHF 300; or',
    entryByTrainText7: 'you cleared with the app QuickZoll.',
    entryByTrainText8: 'In both cases, the goods must not be subject to any restrictions and bans, and they must not require a certificate or authorisation.',
    entryByTrainText9: 'Please pay attention to the symbols on the train or the loudspeaker announcements.',
  },

  forgery: {
    forgeryMainText: 'Forgeries',
    forgerySubText: '',
    forgeryText1: 'It is prohibited to import counterfeited brands and designs. Swiss Customs agents are obliged to confiscate and destroy fakes. It does not matter whether the items are new or used.',
    forgeryText2: 'Buying jewellery and watches abroad',
    forgeryText3: 'Be particularly careful when buying jewellery or watches abroad. Upon inspection, apparent bargains often turn out to be defective or even forgeries.',
    forgeryText4: 'Identifying counterfeit jewellery and counterfeit watches',
    forgeryText5: 'Even an expensive piece of jewellery can prove to be a forgery. An indication of the fineness does not guarantee that the goods are genuine. Buy jewellery and watches only in authorised specialist shops.',
    forgeryText6: 'Further information on product piracy and counterfeits can be obtained from the Swiss Anti-Counterfeiting and Piracy Platform STOP PIRACY: www.stop-piracy.ch',
  },

  cash: {
    cashMainText: 'Liquid funds',
    cashSubText: '',
    cashText1: 'In the case of the importation, transit and exportation of liquid funds (cash and securities, etc.) worth more than CHF 10,000, you must supply information upon request on the origin, the intended use and the beneficial owner.',
    cashText2: 'The right is reserved to take further measures to combat crime.',
  },

  food: {
    foodMainText: 'Restrictions for foodstuffs',
    foodSubText: '',
    foodText1: 'Goods of animal origin for personal use may be imported from EU member states, Iceland and Norway without controls by a border vet. The goods may not be put on sale.',
    foodText2: 'The importation of goods of animal origin from other countries is generally prohibited.\n' +
    ...
    foodText5: 'The importation of products of animal origin from protected animal species is prohibited from all countries. In tourist traffic, there is an import tolerance of 125g per person per day for sturgeon caviar.',
    foodText6: 'Customs duties and VAT',
    foodText7: 'If the tax-free limit of CHF 300 or the duty-free allowances for certain foodstuffs are exceeded, you must pay VAT and/or customs duty. More detailed information can be found at:',
    foodText8: 'Tax-free limit CHF 300',
    foodText9: 'Duty-free allowances: foodstuffs, alcohol and tobacco',
  },

  authorisationRequirements: {
    authorisationRequirementsMainText: 'Authorisation requirement / restrictions',
    authorisationRequirementsSubText: '',
    authorisationRequirementsText1: 'The importation of certain goods is restricted and is possible only under certain conditions (e.g. with prior authorisation), and even complete import bans are applicable in the case of some products.',
    authorisationRequirementsText2: 'The following goods in particular are subject to restrictions (non-exhaustive list):',
    authorisationRequirementsText3: 'Weapons (e.g. firearms, knives, stun guns, tear gas sprays, truncheons, etc.)',
    authorisationRequirementsText4: 'Speed camera warning devices',
    authorisationRequirementsText5: 'Narcotics',
    authorisationRequirementsText6: 'Medications amounting to more than a month\'s personal supply',
    authorisationRequirementsText7: 'Doping substances',
    authorisationRequirementsText8: 'Goods containing depictions of violence',
    authorisationRequirementsText9: 'Goods containing prohibited depictions of pornography',
    authorisationRequirementsText10: 'Counterfeited branded and designer articles, pirated copies',
    authorisationRequirementsText11: 'Cultural property',
  },

  purchasesOnlineOffline: {
    purchasesOnlineOfflineMainText: 'Online shopping, postal and courier consignments',
    purchasesOnlineOfflineSubText:'',
    purchasesOnlineOfflineText1: 'Consignments from abroad are generally subject to customs duty and value added tax (VAT). We show you below how you can roughly calculate the costs and what to consider when importing.',
    purchasesOnlineOfflineText2: 'Please note that a definitive calculation is not possible, as the costs of the transporter, e.g. Swiss Post, are not known in advance. The costs are generally billed to the recipient together with the customs duty and taxes (e.g. VAT). This should be clarified with the corresponding transporter.',
    purchasesOnlineOfflineText3: 'Gift items sent by private individuals abroad to private individuals in Switzerland are exempt from duties and tax up to a merchandise value of CHF 100, but not in the case of tobacco products and alcoholic beverages. The sender must label the outside of the parcel or letter accordingly.',
    purchasesOnlineOfflineText4: 'Sample calculation – taxable value of goods',
    purchasesOnlineOfflineText5: 'You ordered a handheld vacuum cleaner from a German online shop. The purchase price was EUR 150.00 (net amount, excluding foreign VAT). An additional EUR 12.50 had to be paid to the online shop for dispatch to Switzerland. The overall payment to the online shop was EUR 162.50.',
    purchasesOnlineOfflineText6: 'Total amount according to the online shop invoice',
    purchasesOnlineOfflineText7: 'Amount in CHF: 198.25',
    purchasesOnlineOfflineText8: 'Comments: EUR 162.50 converted into CHF at a rate of 1.22.'
      purchasesOnlineOfflineText9: 'Swiss Post costs for customs declaration',
      purchasesOnlineOfflineText10: 'Amount in CHF: 17.95',

    purchasesOnlineOfflineText11: 'Swiss Post costs for opening the consignment',
    purchasesOnlineOfflineText12: 'Amount in CHF: 13.00',

    purchasesOnlineOfflineText13: 'The sender did not provide sufficient details on the contents of the parcel, which is why Swiss Post had to open it for clearance.',
    purchasesOnlineOfflineText14: 'Total taxable value of goods',
      purchasesOnlineOfflineText15: 'Amount in CHF: 229.00',

    purchasesOnlineOfflineText16: 'VAT is calculated based on this amount (rounded to the nearest franc).',
    purchasesOnlineOfflineText17: 'Please note: This sample calculation is a general calculation for duty-free goods.',
  },
